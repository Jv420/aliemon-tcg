...
const main = async () => {
  ...
  try {
    ...
    const transactionPack = createNewPack({
      ...
      packMetadata: {
        name: "Lengendary Pack (#3)",
        image:
          "https://349727a4ec341e84982e34ffb54950c3.ipfscdn.io/ipfs/bafybeihoeq6okfrjcdt5cr5acf3apfwsr7nfvuh2ja6ap2gznkctvm5dce/",
        description: "Only Lendendary Cards",
      },
